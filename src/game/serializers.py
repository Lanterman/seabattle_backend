...
class BaseLobbySerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = models.Lobby
        fields = ["url", "name", "slug", "is_play_with_a_bot", "created_in", "finished_in", "password", "winner"]
...
class CreateLobbySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Lobby
        fields = ["name", "bet", "is_play_with_a_bot", "time_to_move", "time_to_placement", "password", "slug"]
        extra_kwargs = {
            "slug": {"read_only": True},
...
class RetrieveLobbySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Lobby
        fields = ["id", "name", "bet", "is_play_with_a_bot", "winner", "password", 
                  "time_to_move", "time_to_placement", "users", "boards", "messages"]
